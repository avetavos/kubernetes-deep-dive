...
export const quizRbac = [
  ...
  {
    q: 'ทำไม Pod ถึงมีตัวตนแบบ RBAC ทั้งที่ไม่เคยตั้งค่า ServiceAccount ให้เองเลย',
    options: [
      'Pod ที่ไม่มีตัวตนถูกกำหนดไว้จะถูกปฏิเสธตั้งแต่ admission',
      'รันเป็น default ServiceAccount ของ namespace นั้นโดยอัตโนมัติ',
      'สืบทอดตัวตนจากโหนดที่ถูก schedule ไป',
