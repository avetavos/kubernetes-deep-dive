...
export const quizPodSecurity = [
  ...
  },
  {
    ...
    options: [
      'การ encode แบบ base64 เป็น encryption ที่แข็งแรงอยู่แล้วในตัวเอง',
      'base64 เป็นแค่ encoding ไม่ใช่ encryption ใครก็ตามที่มีสิทธิ์อ่าน Secret หรือเข้าถึงข้อมูลของ etcd สามารถ decode ออกมาได้ง่ายมากถ้าไม่มี etcd encryption at rest',
