...
<Mermaid title="วงจรชีวิต container: startup probe กั้น liveness กับ readiness ก่อนที่จะรันต่อเนื่อง" code={probeLifecycleDiagram} />
...
export const quizProbes = [
  ...
  },
  {
    ...
    options: [
      ...
      'ให้เวลา container ที่ start ช้าได้ boot จนเสร็จ ด้วยการปิด liveness กับ readiness ไว้จนกว่าจะผ่าน',
