...
export const quizHelm = [
  ...
  },
  {
    ...
    options: [
      'แค่ render Chart ให้เป็น Kubernetes manifest ธรรมดาในเครื่อง โดยไม่ได้ติดตั้งอะไรเข้า cluster',
      'ติดตั้ง Chart แต่ข้ามการสร้าง Release record',
      'ใช้ได้แค่กับ Chart ที่ไม่มี values.yaml เท่านั้น',
      'เหมือนกับ helm install ทุกประการ',
    ],
    answer: 0,
  },
];
