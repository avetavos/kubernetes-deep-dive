...
export const quizProductionChecklist = [
  ...
  },
  {
    ...
    options: [
      'fail เสมอเวลารันใน cluster และทำงานได้แค่บน laptop เท่านั้น',
      'ใน cluster client จะใช้ ServiceAccount token ที่ mount ไว้ ส่วนบน laptop จะ fallback ไปที่ KUBECONFIG หรือ ~/.kube/config โดยไม่ต้องแยก logic เลย',
      'ต้องใช้ method ชื่อคนละตัวกันแล้วแต่ environment',
      'ทำงานได้ก็ต่อเมื่อตั้ง environment variable KUBECONFIG เองในทั้งสอง environment',
    ],
    answer: 1,
  },
];
